 ...
 Bases: {bases}
  Type: {type}
    ...
    def do_delete(self, args):
        """Delete code in Talus

        code delete <CODE_ID_OR_NAME>
        """
        #args = shlex.split(args)
        print args
        parser = self._argparser()
        ...
        code = self._talus_client.code_find(args.name_or_id, **search)
        self._talus_client.code_delete(code.name)
        print("deleted. Please git rm -r {}/{} and git commit".format(code.type, code.name))
